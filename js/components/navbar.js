...
export class Navbar {
  ...
  initElements() {
    ...
    this.mobileSearchDropdown = document.getElementById('mobile-search-dropdown-bar');
    this.mobileSearchInput = document.getElementById('mobile-search-input');
    this.btnMobileSearchClose = document.getElementById('btn-mobile-search-close');
  ...
  attachEvents() {
    ...
    if (this.btnMobileSearchToggle && this.mobileSearchDropdown) {
      this.btnMobileSearchToggle.addEventListener('click', () => {
        this.mobileSearchDropdown.classList.toggle('open');
        if (this.mobileSearchDropdown.classList.contains('open') && this.mobileSearchInput) {
          this.mobileSearchInput.focus();
        }
      });
    }

    if (this.btnMobileSearchClose && this.mobileSearchDropdown) {
      this.btnMobileSearchClose.addEventListener('click', () => {
        this.mobileSearchDropdown.classList.remove('open');
