...
export class DashboardView {
  ...
  renderFeaturedMemories(allMedia) {
    ...
    highlights.forEach((item, index) => {
      ...
      card.innerHTML = `
        ${isVideo ? `<video src="${thumb}" muted preload="metadata"></video><span class="media-badge-video"><iconify-icon icon="lucide:play"></iconify-icon></span>` : `<img src="${thumb}" alt="${item.fileName || 'Featured'}" loading="lazy" onerror="this.onerror=null;this.src='${FALLBACK_IMAGE_DATA_URI}';">`}
