...
export class MapView {
    ...
    this.tripPhotos.forEach((item, index) => {
      ...
      const popupHtml = `
        <div class="map-popup-card">
          <img src="${thumb}" class="map-popup-thumb" alt="${item.fileName || 'Waypoint'}" onerror="this.onerror=null;this.src='${FALLBACK_IMAGE_DATA_URI}';">
  ...
  renderMarkers() {
    ...
    Object.values(coordClusters).forEach((cluster) => {
      ...
      // Popup Content
      const thumb = resolveMediaUrl(firstItem);
      const popupHtml = `
        <div class="map-popup-card">
          <img src="${thumb}" class="map-popup-thumb" alt="${firstItem.fileName || 'Photo'}" onerror="this.onerror=null;this.src='${FALLBACK_IMAGE_DATA_URI}';">
